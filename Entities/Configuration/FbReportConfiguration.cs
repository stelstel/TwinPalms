        ...
        public void Configure(EntityTypeBuilder<FbReport> builder)
        {
            ...
            (
                new FbReport
                {
                    ...
                    GSourceOfBusinessNotes = "A lot of drunk people just dropped in at around 1:00 AM",
                    Date = DateTime.Now,
                    OutletId = 1,
                ...
                new FbReport
                {
                    ...
                    IsPublicHoliday = false,
                    EventNotes = "The Flamenco dance lesson was quite nice, had meny people dancing",
                    GSourceOfBusinessNotes = "Lorem Ipsum Google",
                ...
                new FbReport
                {
                    ...
                    GSourceOfBusinessNotes = "Hectic day. A lot of fat Germans. Since the didn't speak english we were unable to find out how they got to know of the Umpa Umpa Madness Night",
