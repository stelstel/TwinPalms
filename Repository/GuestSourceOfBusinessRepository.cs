...
namespace Repository
{
    ...
    {
        public GuestSourceOfBusinessRepository(RepositoryContext repositoryContext)
        ...
        public void DeleteGuestSourceOfBusiness(GuestSourceOfBusiness guestSourceOfBusiness)
        {
            Delete(guestSourceOfBusiness);
        }

        public void UpdateGuestSourceOfBusiness(GuestSourceOfBusiness guestSourceOfBusiness)
        {
            Update(guestSourceOfBusiness);
        }
